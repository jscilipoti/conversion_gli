...
!C    Temperatura, presion, composicion, nro de componentes
!C    *******************************************************************  
!C    *                                                                 *  
!C    *  PROGRAM   L L E C A L A S                                      *  
!C    *  (asociacion incorporada para el calculo de flash y             *  
!C    *  curva binodal (icalc 0 y 1)                                    *
!C    *                                                                 *
!C    *                       ASOCIACION CRUZADA					         *		  
!C    *                      VERSION GENERALIZADA                       *        
!C    *                          Junio 2023                             *
!C    *  MODIFICADA POR:                                                *
!C    *                    ALFONSINA  ESTER ANDREATTA                   *
!C    *                    JOSE ANTONIO SCILIPOTI                       *  
!C    *                    JUAN PABLO ROVEZZI                           *
!C    *       Revisada en Octubre del 2007 en el chequeo de estabilidad *
!C    *                                                                 *  
!C    *        BASADA EN LAS SIMPLIFICACIONES DE LOS PAPERS:            * 	
!C    *  Michelsen, et al. (Fluid Phase Equilibria, 180(2001)165-174 )  *		
!C    *  Tan, et al.  (Ind. Eng. Chem. Res, 2004, 43, 203-208).			   *	   	
!C    *																                  *	   	
!C    *        Esto permitio  que todos los casos particulares          *         
!C    *       de asociacion se puedan simplificar a un unico calculo.   * 
!C    *                                                                 *
!C    *  Valido para un maximo numero grupo asociativo de 12.           *
!C    *  Con la implementacion en el calculo de la fraccion no asociada *   
!C    *  en el componente puro por  el metodo iterativo aqui            *
!C    *  implementado se permite queuna molecula tenga mas de un grupo  *
!C    *  asociativo 14/07/06.                                           * 
!C    *  El calculo se limita a que el numero maximo de sitios sea      * 
!C    *  dos (por razones matematicas).                                 *
!C    *                                                                 *                                                   
!C    *******************************************************************  
!C    *                                           DATE: 24/3 - 1982 /TJ *
!C    *******************************************************************
      ...
      use InputData
      use flashout
      IMPLICIT REAL*8(A-H, O-Z)      !QUITAR                                    
      EXTERNAL STABIL, GMIX, FUNC                                         
      COMMON/CVAP/NOVAP, NDUM, IDUM(4), PRAT(10)                           
      COMMON/CGIBBS/NF, MAXZ, GNUL, Z(10), A(10), XVL(10, 4), SFAS(4), GAM(10, 10), &
      & AL(10), DA(10, 10), XM(10, 4)                                       
...
!           4-'GC-EOS parameters'
   ...
   18       P(I, J)=0.                                                         
      ...
      !(///, ' ** UNIQUAC PARAMETERS FROM UNIFAC **', //, 5X, 'A12/R =  ', F12.3, ' K , A21/R = ', F12.3, ' K', ///)                                  
...
!C Calculo de  los elementos de la matriz [Yp] 
