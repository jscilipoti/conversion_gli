program check
    ...
    if (abs(zf_check(1) - ULV7_data(1))>1E-8) ERROR STOP "Zf of component 1 has changed"
    if (abs(zf_check(2) - ULV7_data(2))>1E-8) ERROR STOP "Zf of component 2 has changed"
    if (abs(zf_check(3) - ULV7_data(3))>1E-8) ERROR STOP "Zf of component 3 has changed"
    if (abs(zf_check(4) - ULV7_data(4))>1E-8) ERROR STOP "Zf of component 4 has changed"
    if (abs(zf_check(5) - ULV7_data(5))>1E-8) ERROR STOP "Zf of component 5 has changed"
    if (abs(zf_check(6) - ULV7_data(6))>1E-8) ERROR STOP "Zf of component 6 has changed"
    if (abs(zf_check(7) - ULV7_data(7))>1E-8) ERROR STOP "Zf of component 7 has changed"
    if (abs(ksalida_check(1) - ULV7_data(8))>1E-8) ERROR STOP "K1 has changed"
    if (abs(ksalida_check(2) - ULV7_data(9))>1E-8) ERROR STOP "K2 has changed"
    if (abs(ksalida_check(3) - ULV7_data(10))>1E-8) STOP "K3 has changed"
