...
subroutine leer_input_flash_ULL7()
    use InputData
    use flash
    use CUFAC 
    implicit none    
    ...
    READ(2,*) (Z(I),I=1,NKK)  
    close(unit=2)
endsubroutine leer_input_flash_ULL7

subroutine open_file_name_ULL7()
    use InputData
    implicit none
...
endsubroutine open_file_name_ULL7